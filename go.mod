...
replace (
	github.com/dunglas/frankenphp v1.11.3 => ./deps/frankenphp
	github.com/extism/go-sdk v1.7.1 => ./deps/extism-go-sdk
	github.com/tetratelabs/wazero v1.9.0 => ./deps/wazero
)
